<template>
  <div class="relative h-screen w-full flex justify-center items-center overflow-hidden">
    ...
    <div class="z-10 flex justify-center absolute top-5 left-1/2 -translate-x-1/2">
      <LilitaText class="text-stroke-4 text-6xl">Pengembang</LilitaText>
    </div>
    <div class="relative flex justify-center items-end w-[70%] h-[70%] p-2 bg-blue-900 bg-opacity-90">
      ...
      <div class="flex flex-col items-center w-[90%] h-[90%]">
        <div class="my-4 text-xl font-semibold p-2 bg-white border-2 border-black">Pengembang</div>
        <span class="text-white text-lg font-semibold">Syahaarah Salsabila Gunawan</span>
        <span class="text-white text-lg font-semibold">UNIVERSITAS PENDIDIKAN INDONESIA</span>
        <span class="text-white text-lg font-semibold">Syahaarahs@gmail.com</span>
        <span class="text-white text-lg font-semibold">087731668600</span>
      </div>
    </div>
