<template>
  <div class="relative h-screen w-full flex justify-center items-center overflow-hidden">
    ...
    <div v-show="currentPage < 7" class="h-16 w-16 md:w-24 absolute top-1/2 -translate-y-1/2 right-0 flex justify-evenly items-center">
    ...
    <div class="relative flex justify-center items-end w-[80%] h-[80%] p-2 bg-blue-900 bg-opacity-90">
      ...
      <div class="flex justify-center items-center gap-2 w-[95%] h-[90%] z-10">
         ...
         <div id="page-1" v-show="currentPage === 1" class="w-full pt-2 pb-4 h-full overflow-auto">
          ...
          <p class="text-white text-xs">Perhatikan pernyataan berikut ini:
         ...
         <div id="page-2" v-show="currentPage === 2" class="w-full pt-2 pb-4 h-full overflow-auto">
          ...
          <Element src="/element/my-plateq3.png" class="mt-2"></Element>
          <span class="text-white text-xs font-bold">Pertanyaan</span>
          <p class="text-white text-xs mb-1">
         ...
         <div id="page-3" v-show="currentPage === 3" class="w-full pt-2 pb-4 h-full overflow-auto">
          ...
          <p class="text-white text-xs mb-1">Aspek spesifik apa yang akan diuji dalam eksperimen ini terkait kepatuhan terhadap MyPlate dan kebiasaan makan sehat?</p>
          <client-only>
         ...
         <div id="page-6" v-show="currentPage === 6" class="w-full pt-2 pb-4 h-full overflow-auto">
          <span class="text-white text-xs font-bold"> Jawablah pertanyaan-pertanyaan berikut dengan benar:</span>
          <p class="text-white text-xs mb-1">Mengapa makanan kaya serat, seperti biji-bijian dan sayuran, penting bagi tubuh?</p>
          <client-only>
          ...
          <client-only>
            <QuillEditor v-model:modelValue="answers.a4"/>
          </client-only>
         </div>
         <!-- End of PAGE 6 -->
          <!-- Start of PAGE 7 -->
