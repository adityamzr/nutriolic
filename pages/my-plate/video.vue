<template>
  <div class="relative h-screen w-full flex justify-center items-center overflow-hidden">
    ...
    <div class="z-10 min-w-[380px] flex justify-center absolute top-5 lg:top-12 left-1/2 -translate-x-1/2">
    ...
    <div class="relative flex justify-center items-end w-[75%] h-[75%] p-2 bg-blue-900 bg-opacity-90">
      ...
      <div class="flex justify-center gap-2 w-[90%] h-[90%] z-10">
        <div class="flex flex-col justify-center w-[65%] md:w-[70%]">
          <Video src="/video/my-plate.mp4" class="h-auto"></Video>
          <span class="text-white text-xs lg:text-xl">jika Anda sudah memahami videonya, silakan klik tombol "Play" di samping untuk melanjutkan perjalanan kita!</span>
        </div>
        <!-- <div class="flex flex-col items-center justify-between grow"> -->
        <div class="flex items-end justify-center grow">
          <Element @click="handleClick('/my-plate/material')" src="/element/start.png" customClass="cursor-pointer w-20 lg:w-40 mb-8 lg:mb-16"/>
        </div>
      </div>
    </div>
    <div class="absolute w-24 md:w-20 lg:w-80 right-[170px] md:right-56 top-20 lg:top-32">
      <div class="relative items-center w-44 md:w-48 lg:w-80">
        ...
        <div class="absolute top-0 lg:top-10 left-1/2 -translate-x-1/2 h-[120px] w-36 md:h-32 md:w-40 lg:h-40 lg:w-52 inset-0 flex items-center justify-center px-2 text-xs lg:text-lg text-center font-semibold text-black">
          Halo murid-murid yang pintar, tonton video tentang 'isi piringku' dengan seksama!
        </div>
      </div>
    </div>
    <div class="absolute w-32 md:w-40 lg:w-72 right-2 bottom-0">
      <ChefRight class="lg:w-72"/>
    </div>
  </div>
</template>
