<template>
  <div class="relative h-screen w-full flex justify-center items-center overflow-hidden">
    ...
    <div class="flex flex-col justify-center items-center w-[60%] lg:w-[60%] h-[90%] mr-2">
      ...
      <input v-model="onboarding" type="text" name="onboarding" class="w-full py-1 text-xs lg:text-lg text-white bg-transparent border-b-2 border-dashed border-white ob2 hidden"></input>
    </div>
